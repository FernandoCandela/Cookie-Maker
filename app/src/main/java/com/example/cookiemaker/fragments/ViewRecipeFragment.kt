...
class ViewRecipeFragment(var recipeId: Int) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rviRecipeIngredient.adapter =
            NewRecipeIngredientsAdapter(
                RecetasManager().getInstance().getReceta(recipeId)?.ingredientes!!
            )
    }
}